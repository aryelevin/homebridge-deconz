  ...
  async heartbeat (beat) {
    try {
      ...
      if ((!this.allPanels.length && Object.keys(this.panelsToResources).length) || (beat % updateWeatherEvery === 0 && this.allPanels.length)) {
        ...
        https.get('https://api.open-meteo.com/v1/forecast?latitude=32.08934&longitude=34.83760&hourly=relativehumidity_2m,uv_index&current_weather=true&forecast_days=1', res => {
          let data = []
