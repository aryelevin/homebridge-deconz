...
class Light extends DeconzService.LightsResource {
  ...
  updatePanel(pathComponents, parameter, content) {
    ...
    let that = this
    const dataToSend = '19aa7113446d21054110' + '6c69676874732f' + parseInt(pathComponents[4].charAt(pathComponents[4].length-1)).toString(16).padStart(2, '0') + parameter + content
