...
class Light extends DeconzService.LightsResource {
  constructor (accessory, resource, params = {}) {
    ...
    this.addCharacteristicDelegate({
      ...
      if (fromHomeKit) {
        if (this.gateway.platform._configJson.homeassistantMode && this.gateway.platform._configJson.portToUseForHomeassistant) { 
  ...
  updateState (state, rpath, stateKey = 'state') {
    // Added by me: Arye Levin
    if (!this.gateway.platform._configJson.homeassistantMode && ((this.gateway.platform._configJson.resourcesToIgnoreDeviceStateUpdates !== undefined && this.gateway.platform._configJson.resourcesToIgnoreDeviceStateUpdates?.includes('/' + this.gateway.id + this.resource.rpath)) || (this.gateway.platform._configJson.shabbatModeCLIPSensor !== undefined && !this.gateway.platform.platformAccessory.service.values.switchesOn))) {
