...
class Light extends DeconzService.LightsResource {
  ...
  updateState (state, rpath, stateKey = 'state') {
    // if (((state.on !== undefined && state.on != this.values.on) || (state.bri !== undefined && state.bri != this.values.brightness) || (state.ct !== undefined && state.ct != this.values.colorTemperature)) && this.resource.manufacturer !== 'ubisys' && this.resource.manufacturer !== 'EcoDim B.V' && this.resource.manufacturer !== 'ROBB smarrt' && this.resource.manufacturer !== 'AduroSmart Eria' && this.resource.manufacturer !== 'SmartDimmer' && this.resource.manufacturer !== 'Idinio' && this.resource.model !== 'lumi.switch.n4acn4') {
