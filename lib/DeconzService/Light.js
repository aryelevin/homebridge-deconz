    ...
    this.addCharacteristicDelegate({
      ...
      if (fromHomeKit) {
        if (this.gateway.platform._configJson.useHTTPRequestsForPUTWithPort) { 
          this.platform.platformAccessory.sendPUTRequestToServer(this.gateway.id, this.accessory.id, this.resource.subtype, this.Characteristics.hap.On.displayName, value)
        } else {
