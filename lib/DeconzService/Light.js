...
class Light extends DeconzService.LightsResource {
  ...
  putState () {
    if (/*Fingerbot -> */this.resource.manufacturer === '_TZ3210_dse9ogfy' && this.resource.model === 'TS0001'/*(this.config.doorLock && this.service.getCharacteristic(Characteristic.LockCurrentState).value == this.service.getCharacteristic(Characteristic.LockTargetState).value)*/) {
