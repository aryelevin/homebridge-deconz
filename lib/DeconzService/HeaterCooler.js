...
class HeaterCooler extends DeconzService.SensorsResource {
  ...
  updatePanel(panelResourcePathComponents) {
    ...
    let panelResourcePath = '/' + panelResourcePathComponents[2] + '/' + panelResourcePathComponents[3] + '/state'
    this.gateway.platform.gatewayMap[panelResourcePathComponents[1]].client.put(panelResourcePath, {aqara_s1_panel_communication: '19aa7113446d21054110' + '6169725f636f6e64' + newState}).then((obj) => {
