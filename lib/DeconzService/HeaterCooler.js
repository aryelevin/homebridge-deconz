...
class HeaterCooler extends DeconzService.SensorsResource {
  ...
  updatePanel(pathComponents) {
    ...
    const that = this
    let internalThermostat = this.gateway.platform._configJson.actionsConfigData[pathComponents[1]].aqara_S1_panels['/' + pathComponents[2] + '/' + pathComponents[3]].ac.internal_thermostat
