...
class Switch extends DeconzService.LightsResource {
  ...
  updateState (state) {
    ...
    if (this.platform._configJson.excludeForceState !== undefined && this.resource.manufacturer !== 'ubisys' && this.resource.manufacturer !== 'EcoDim B.V' && this.resource.manufacturer !== 'ROBB smarrt' && this.resource.manufacturer !== 'AduroSmart Eria' && this.resource.manufacturer !== 'SmartDimmer' && this.resource.manufacturer !== 'Idinio' && (this.resource.model !== 'lumi.switch.n4acn4' || !this.platform.platformAccessory.service.values.switchesOn) && (this.resource.model !== 'lumi.switch.n1acn1' || !this.platform.platformAccessory.service.values.switchesOn) && !this.platform._configJson.excludeForceState?.includes('/' + this.gateway.id + this.resource.rpath)) {
