            ...
            if (cmdPath && cmdObject) {
              ...
              if (pathComponents.length === 5) {
                ...
                if (aqaraS1Bridge) {
                  ...
                  this.info('Bridge not found')
                }
              } else {
                this.info('Command path is not correct length: ' + pathComponents.length)
              }
            } else {
              this.info('Missing command data: ' + JSON.stringify(cmd))
            }
          }
        } else {
          this.info('No commands to execute')
        }
      }
    })
