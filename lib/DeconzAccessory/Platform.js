      ...
      if (req.method === 'POST' && req.headers['content-type'] === 'application/json') {
        ...
        req.on('end', () => {
          try {
            ...
            this.platform.gatewayMap[gatewayId]?.accessoryById[accessoryId]?.serviceBySubtype[subtype]?._service?._characteristicDelegates[characteristic]?._characteristic?.setValue(value)
          } catch (error) {
