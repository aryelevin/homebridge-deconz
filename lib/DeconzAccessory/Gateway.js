                    ...
                    if (accessoryToControl) {
                      ...
                      var repeatZBFunction = function(delay, timeoutKey) {
                        longPressTimeoutIDs[timeoutKey] = setTimeout(function() {
                          ...
                          if (((sensorTypeInt === 2 && body.state.buttonevent === 1001) || ((sensorTypeInt === 0 || sensorTypeInt === 1) && body.state.buttonevent === 2001)) && service.testCharacteristic(that.platform.Characteristics.hap.Brightness)) { // Start Increasing the Brightness on tunr on at lowest brighness if Off...
                            if (!service.getCharacteristic(that.platform.Characteristics.hap.On).value) {
                              ...
                              var characteristic = service.getCharacteristic(that.platform.Characteristics.hap.Brightness);
                            ...
                            var characteristic = service.getCharacteristic(that.platform.Characteristics.hap.ColorTemperature);
