    ...
    if (sum === 512 || sum === 256 || sum === 768) {
      if (commandType === 0x84) {
        ...
        if (commandCategory === 0x72 && commandAction === 0x01) { // State of device is reported.
          ...
          this.log('Light configuration completed received... from: ' + rpath + 'Hex data: ' + updateData)
        } else {
        ...
        if (commandCategory === 0x71 && commandAction === 0x02) { // ACKs for confguration commmands...
          if (this.configurationCommandsToExecute.length) {
            ...
            const currentCommand = currentConfiguredDeviceCommandsObject.commands[currentConfiguredDeviceCommandsObject.meta.index]
            let slotIdIndex = 20
