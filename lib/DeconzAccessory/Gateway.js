                      ...
                      function executeCommand(index) {
                        ...
                        that.client.put(panel + '/config', {aqara_s1_communication: cmdToSend}).then((obj) => {
                          ...
                          if (index < commandsFunctionsToExecute.length) {
                            setTimeout(function(){commandsFunctionsToExecute[index](index+1)}, 500)
                          }
                        }).catch((error) => {
        ...
        try {
          ...
          if (rtype === 'sensors' && body.state !== undefined && body.state.buttonevent !== undefined && this.actionsConfigData && this.actionsConfigData[rid] && this.actionsConfigData[rid].length && this.platform.platformAccessory.service.values.switchesOn) {
            ...
            if (rtype === 'sensors' && body.config !== undefined && body.config['aqara_s1_communication'] !== undefined && body.config['aqara_s1_communication'] !== this.context.fullState[rtype][rid].config.aqara_s1_communication) {
              this.log('Aqara panel sent data %s', JSON.stringify(body))
              ...
              let sum = dataArray[dataStartIndex] + dataArray[dataStartIndex + 1] + dataArray[dataStartIndex + 2] + dataArray[dataStartIndex + 3] + dataArray[dataStartIndex + 4] + getInt8(dataArray[dataStartIndex + 5])
  
              this.debug('Data array: ' + dataArray + ', Integrity: ' + dataArray[dataStartIndex + 5] + ', Signed integrity: ' + getInt8(dataArray[dataStartIndex + 5]) + ', Sum: ' + sum)
                ...
                if (deviceResourceType) {
                  if (commandCategory === 0x72 && commandType === 0x84 && commandAction === 0x01 && this.platform.platformAccessory.service.values.switchesOn) { // State of device is reported.
                    if (deviceResourceType === 'air_cond' && stateParam[0] === 0x0e && stateParam[2] === 0x00 && stateParam[3] === 0x55 && (stateParam[1] === 0x20 || stateParam[1] === 0x02)) { // Updated Air conditioner/Heater-Cooler device state
                      ...
                      let onOff = dataArray[dataStartIndex + 24] === 0x01
                      ...
                      let brightness = dataArray[dataStartIndex + 24]
                      ...
                      let colorTemperature = parseInt(dataArray[dataStartIndex + 23].toString(16).padStart(2, '0') + dataArray[dataStartIndex + 24].toString(16).padStart(2, '0'), 16)
                      ...
                      let colorX = parseInt(dataArray[dataStartIndex + 21].toString(16).padStart(2, '0') + dataArray[dataStartIndex + 22].toString(16).padStart(2, '0'), 16)
                      let colorY = parseInt(dataArray[dataStartIndex + 23].toString(16).padStart(2, '0') + dataArray[dataStartIndex + 24].toString(16).padStart(2, '0'), 16)
                    ...
                    if (deviceResourceType === 'air_cond' && stateParam[0] === 0x0e && stateParam[2] === 0x00 && stateParam[3] === 0x55 && (stateParam[1] === 0x20 || stateParam[1] === 0x02)) { // Updated Air conditioner/Heater-Cooler device state
                      ...
                      if (accessoryToControl && accessoryToControl.service._service.testCharacteristic(this.platform.Characteristics.hap.TargetPosition)) {
                        let hkPosition = accessoryToControl.service._service.getCharacteristic(this.platform.Characteristics.hap.TargetPosition).value
                        ...
                        this.log('HK Position: ' + hkPosition + ', Aqara Position: ' + position)
                        
                        this.client.put(rpath + '/config', {aqara_s1_communication: '19aa7113446d210541106375727461696e' + deviceSerial[7].toString(16).padStart(2, '0') + '01010055' + position + '0000'}).then((obj) => {
                      ...
                      if (accessoryToControl) {
                        ...
                        this.client.put(rpath + '/config', {aqara_s1_communication: '19aa7113446d210541106c69676874732f' + deviceSerial[7].toString(16).padStart(2, '0') + '04010055' + '0000000' + (onOff ? '1' : '0')}).then((obj) => {
                      ...
                      if (accessoryToControl) {
                        ...
                        this.client.put(rpath + '/config', {aqara_s1_communication: '19aa7113446d210541106c69676874732f' + deviceSerial[7].toString(16).padStart(2, '0') + '0e010055' + '000000' + brightness.toString(16).padStart(2, '0')}).then((obj) => {
                      ...
                      if (accessoryToControl) {
                        ...
                        this.client.put(rpath + '/config', {aqara_s1_communication: '19aa7113446d210541106c69676874732f' + deviceSerial[7].toString(16).padStart(2, '0') + '0e020055' + '0000' + colorTemperature.toString(16).padStart(4, '0')}).then((obj) => {
                      ...
                      if (accessoryToControl) {
                        ...
                        this.client.put(rpath + '/config', {aqara_s1_communication: '19aa7113446d210541106c69676874732f' + deviceSerial[7].toString(16).padStart(2, '0') + '0e080055' + Math.round(xy[0] * 65535).toString(16).padStart(4, '0') + Math.round(xy[1] * 65535).toString(16).padStart(4, '0')}).then((obj) => {
                      ...
                      this.log('Name data: ' + dataToSend)
                      this.client.put(rpath + '/config', {aqara_s1_communication: dataToSend}).then((obj) => {
                      ...
                      this.client.put(rpath + '/config', {aqara_s1_communication: '19aa7113446d21054110' + (deviceResourceType === 'lights/' ? ('6c69676874732f' + deviceSerial[7].toString(16).padStart(2, '0')) : deviceResourceType === 'curtain' ? ('6375727461696e' + deviceSerial[7].toString(16).padStart(2, '0')) : '6169725f636f6e64') + '080007fd' + '00000001'}).then((obj) => {
