  ...
  processIncomingButtonEvent (rid, buttonevent) {
    ...
    for (let i = actionsConfig.length - 1; i >= 1; i--) {
      ...
      if (actionConfig.resourcePath && actionConfig.resourcePath.startsWith('/')) {
        ...
        if (((sensorTypeInt === 2 && buttonevent === 1001) || ((sensorTypeInt === 0 || sensorTypeInt === 1) && buttonevent === 2001)) && service.testCharacteristic(that.platform.Characteristics.hap.Brightness)) { // Start Increasing the Brightness and turn on at lowest brighness if Off...
          actionToDo = 'on_low_bri_up'
        } else if (((sensorTypeInt === 2 && buttonevent === 2001) || ((sensorTypeInt === 0 || sensorTypeInt === 1) && buttonevent === 3001)) && service.testCharacteristic(that.platform.Characteristics.hap.Brightness)) {
          actionToDo = 'bri_down'
        } else if (((sensorTypeInt === 2 && buttonevent === 3001) || (sensorTypeInt === 0 && buttonevent === 4001)) && service.testCharacteristic(that.platform.Characteristics.hap.ColorTemperature)) {
          actionToDo = 'ct_down'
        } else if (((sensorTypeInt === 2 && buttonevent === 4001) || (sensorTypeInt === 0 && buttonevent === 5001)) && service.testCharacteristic(that.platform.Characteristics.hap.ColorTemperature)) {
          actionToDo = 'ct_up'
        } else {
          continueRepeat = false
          ...
          } else if (((sensorTypeInt === 1 && buttonevent === 2000) || (sensorTypeInt === 0 && buttonevent === 2002)) && service.testCharacteristic(this.platform.Characteristics.hap.Brightness)) { // Turn On with lowest brightness or increase the brightness if On already
            actionToDo = 'on_low_bri_up'
          } else if ((/* (sensorTypeInt === 2 && buttonevent === 2002) || Handled down there, acts as Turn Off, on long press it acts as dim down... */(sensorTypeInt === 1 && buttonevent === 3000) || (sensorTypeInt === 0 && buttonevent === 3002)) && service.testCharacteristic(this.platform.Characteristics.hap.Brightness)) { // Decrease the brightness
            actionToDo = 'bri_down'
          } else if (((sensorTypeInt === 2 && buttonevent === 3002) || (sensorTypeInt === 0 && buttonevent === 4002)) && service.testCharacteristic(this.platform.Characteristics.hap.ColorTemperature)) { // Increase the CT
            actionToDo = 'ct_down'
          } else if (((sensorTypeInt === 2 && buttonevent === 4002) || (sensorTypeInt === 0 && buttonevent === 5002)) && service.testCharacteristic(this.platform.Characteristics.hap.ColorTemperature)) { // Decrease the CT
            actionToDo = 'ct_up'
          ...
          if (this.initialised) {
            if (rtype === 'sensors' && body.state !== undefined && body.state.buttonevent !== undefined && this.actionsConfigData && this.actionsConfigData[rid] && this.actionsConfigData[rid].length && this.platform.platformAccessory.service.values.switchesOn) {
              ...
              if (rtype === 'sensors' && body.config !== undefined && body.config.aqara_s1_communication !== undefined && /* body.config.aqara_s1_communication !== this.context.fullState[rtype][rid].config.aqara_s1_communication && */!(/* body.config.aqara_s1_communication[4] === '7' && body.config.aqara_s1_communication[5] === '1' && */body.config.aqara_s1_communication[8] === '4' && (body.config.aqara_s1_communication[9] === '4' || body.config.aqara_s1_communication[9] === '6'))) { // Command Category 71 and Command Type 44/46 is our sent commands, so ignore these...
                ...
                const updateData = body.config.aqara_s1_communication
