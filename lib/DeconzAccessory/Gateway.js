                  ...
                  if (commandCategory === 0x72 && commandType === 0x84 && commandAction === 0x01 && this.platform.platformAccessory.service.values.switchesOn) { // State of device is reported.
                    ...
                    if (deviceResourceType === 'air_cond' && stateParam[0] === 0x0e && stateParam[2] === 0x00 && stateParam[3] === 0x55 && (stateParam[1] === 0x20 || stateParam[1] === 0x02)) { // Updated Air conditioner/Heater-Cooler device state
                      ...
                      if (accessoryToControl) {
                        ...
                        this.log('On/Off: ' + onOff)
                        const that = this
                        const dataToSend = '19aa7113446d210541106c69676874732f' + deviceSerial[7].toString(16).padStart(2, '0') + '04010055' + '0000000' + (onOff ? '1' : '0')
                      ...
                      if (accessoryToControl) {
                        ...
                        this.log('Brightness: ' + brightness)
                        const that = this
                        const dataToSend = '19aa7113446d210541106c69676874732f' + deviceSerial[7].toString(16).padStart(2, '0') + '0e010055' + '000000' + brightness.toString(16).padStart(2, '0')
                      ...
                      if (accessoryToControl) {
                        ...
                        this.log('Color Temperature: ' + colorTemperature)
                        const that = this
                        const dataToSend = '19aa7113446d210541106c69676874732f' + deviceSerial[7].toString(16).padStart(2, '0') + '0e020055' + '0000' + colorTemperature.toString(16).padStart(4, '0')
                      ...
                      if (accessoryToControl) {
                        ...
                        const that = this
                        const dataToSend = '19aa7113446d210541106c69676874732f' + deviceSerial[7].toString(16).padStart(2, '0') + '0e080055' + Math.round(xy[0] * 65535).toString(16).padStart(4, '0') + Math.round(xy[1] * 65535).toString(16).padStart(4, '0')
                      ...
                      const that = this
                      let dataToSend = '19aa7113446d21054110' + (deviceResourceType === 'lights/' ? ('6c69676874732f' + deviceSerial[7].toString(16).padStart(2, '0')) : deviceResourceType === 'curtain' ? ('6375727461696e' + deviceSerial[7].toString(16).padStart(2, '0')) : '6169725f636f6e64') + '080007fd' + '00000001'
