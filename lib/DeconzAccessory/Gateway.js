    ...
    try {
      ...
      if (beat % putStateEvery === 0) {
        ...
        for (var i=0;i<accessoriesArray.length;i++) {
          ...
          for (var ii=0;ii<servicesKeys.length;ii++) {
            if (!servicesKeys[ii].startsWith('/sensors')) {
              ...
              if (serviceToExamine.resource.serviceName && (serviceToExamine.resource.serviceName === 'Light' || serviceToExamine.resource.serviceName === 'Outlet' || serviceToExamine.resource.serviceName === 'Switch')) {
        ...
        if (exposedServices.length) {
          const index = (beat / putStateEvery) % (exposedServices.length)
                ...
                if (slots) {
                  if (deviceConfig) {
                    ...
                    if (i <= 4) { // Lights
                      ...
                      commandsToExecute.push('38aa713244016e02412f' + slotPrefix + slots[0].toString(16).padStart(2, '0') + panelSerial + deviceSerial + '0e020055' + '150a0' + (deviceConfig.type === 'curtain' ? '4' : '5') + '08b4b0c1b1d7b4ccac000000000000014' + (parseInt(deviceSerial.charAt(deviceSerial.length - 1)) + 5) + '3' + (deviceConfig.type === 'curtain' ? '2' : '3') + '00')
                      // Position
                      ...
                      commandsToExecute.push('3caa713644fe6d024133' + slotPrefix + slots[1].toString(16).padStart(2, '0') + panelSerial + deviceSerial + '01010055' + '190a0' + (deviceConfig.type === 'curtain' ? '4' : '5') + '0000010ab4b0c1b1b4f2bfaab0d90000000000014' + (parseInt(deviceSerial.charAt(deviceSerial.length - 1)) + 5) + '0' + (deviceConfig.type === 'curtain' ? 'c' : 'd') + '00')
                      // Online/Offline
                      ...
                      commandsToExecute.push('39aa713344ff6f024130' + slotPrefix + slots[2].toString(16).padStart(2, '0') + panelSerial + deviceSerial + '080007fd' + '160a0' + (deviceConfig.type === 'curtain' ? '4' : '5') + '0ac9e8b1b8d4dacfdfc0eb0000000000014' + (parseInt(deviceSerial.charAt(deviceSerial.length - 1)) + 5) + '3' + (deviceConfig.type === 'curtain' ? 'c' : 'e') + '00')
                      // Name
                      ...
                      commandsToExecute.push('37aa713144007002412e' + slotPrefix + slots[3].toString(16).padStart(2, '0') + panelSerial + deviceSerial + '08001fa5' + '140a0' + (deviceConfig.type === 'curtain' ? '4' : '5') + '08c9e8b1b8c3fbb3c60000000000014' + (parseInt(deviceSerial.charAt(deviceSerial.length - 1)) + 5) + '0' + (deviceConfig.type === 'curtain' ? 'a' : 'b') + '00')
                      ...
                      commandsToExecute.push('3caa7136440962024133' + slotPrefix + slots[5].toString(16).padStart(2, '0') + panelSerial + deviceSerial + '00010055' + '190a050000010ab4b0c1b1d4cbd0d0cab10000000000014' + (parseInt(deviceSerial.charAt(deviceSerial.length - 1)) + 5) + '3f00')
                    } else if (i === 8) { // AC
                      // On/Off, general type...
    ...
    if (sum === 512 || sum === 256 || sum === 768) {
      if (commandType === 0x84) {
        ...
        if (commandCategory === 0x72 && commandAction === 0x01) { // State of device is reported.
          ...
          this.log('panelsToResources: ' + JSON.stringify(this.platform.panelsToResources) + ', this.id: ' + this.id + ', rpath: ' + rpath)

          const sceneConfig = this.platform._configJson.actionsConfigData?.[this.id]?.[rpath]?.['/scene_' + sceneNo]
          ...
          if (sceneExecutionData) {
            ...
            for (let i = resources.length - 1; i >= 0; i--) {
              ...
              const pathComponents = resourcePath.split('/')

              const accessoryToControl = this.platform.gatewayMap[pathComponents[1]].accessoryByRpath['/' + pathComponents[2] + '/' + pathComponents[3]]
              const sceneExecutionActions = sceneExecutionData[resourcePath]

              if (accessoryToControl) {
                if (sceneExecutionActions.on !== undefined) {
                  accessoryToControl.service._service.getCharacteristic(this.platform.Characteristics.hap.On).setValue(sceneExecutionActions.on)
                  // accessoryToControl.service.values.on = sceneExecutionActions.on
                }
                if (sceneExecutionActions.brightness !== undefined) {
                  accessoryToControl.service._service.getCharacteristic(this.platform.Characteristics.hap.Brightness).setValue(sceneExecutionActions.brightness)
                }
                if (sceneExecutionActions.colorTemperature !== undefined) {
                  accessoryToControl.service._service.getCharacteristic(this.platform.Characteristics.hap.ColorTemperature).setValue(sceneExecutionActions.colorTemperature)
                }
                ...
                if (sceneExecutionActions.hue !== undefined && sceneExecutionActions.saturation !== undefined) {
                  accessoryToControl.service._service.getCharacteristic(this.platform.Characteristics.hap.Hue).setValue(sceneExecutionActions.hue)
                  accessoryToControl.service._service.getCharacteristic(this.platform.Characteristics.hap.Saturation).setValue(sceneExecutionActions.saturation)
                }
                if (sceneExecutionActions.active !== undefined) { // For ACs for example
                  accessoryToControl.service._service.getCharacteristic(this.platform.Characteristics.hap.Active).setValue(sceneExecutionActions.active)
                }
                if (sceneExecutionActions.targetTemperature !== undefined) { // For ACs and thermostats
                  ...
                  if (typeof accessoryToControl === 'HeaterCooler') {
                    const currentTargetHeaterCoolerState = accessoryToControl.service._service.getCharacteristic(this.platform.Characteristics.hap.TargetHeaterCoolerState).value
                  ...
                  if (characteristic !== undefined) {
                    accessoryToControl.service._service.getCharacteristic(characteristic).setValue(sceneExecutionActions.targetTemperature)
                  }
                }
                if (sceneExecutionActions.targetState !== undefined) { // For ACs and thermostats
                  ...
                  if (characteristic !== undefined) {
                    accessoryToControl.service._service.getCharacteristic(characteristic).setValue(sceneExecutionActions.targetState)
                  }
                }
                if (sceneExecutionActions.rotationSpeed !== undefined) { // For ACs (, fans and thermostats?)
                  accessoryToControl.service._service.getCharacteristic(this.platform.Characteristics.hap.RotationSpeed).setValue(sceneExecutionActions.rotationSpeed)
                }
                if (sceneExecutionActions.swingMode !== undefined) { // For ACs (, fans and thermostats?)
                  accessoryToControl.service._service.getCharacteristic(this.platform.Characteristics.hap.SwingMode).setValue(sceneExecutionActions.swingMode)
                }
                if (sceneExecutionActions.holdPosition !== undefined) { // For WindowCovering
                  accessoryToControl.service._service.getCharacteristic(this.platform.Characteristics.hap.HoldPosition).setValue(sceneExecutionActions.holdPosition) // Supposed to be boolean
                }
                if (sceneExecutionActions.targetPosition !== undefined) { // For WindowCovering
                  accessoryToControl.service._service.getCharacteristic(this.platform.Characteristics.hap.TargetPosition).setValue(sceneExecutionActions.targetPosition)
                }
