              ...
              for (let i = devicesSerial.length - 1; i >= 0; i--) {
                ...
                if (slots) {
                  if (deviceConfig) {
                    ...
                    if (i <= 4) { // Lights
                      // On/Off, general type...
                      commandsToExecute.push(...this.generateAqaraS1ScenePanelCommands('02', slotPrefix + slots[0].toString(16).padStart(2, '0') + panelSerial + deviceSerial + '04010055' + '260a0' + (deviceConfig.type === 'dim' ? '4' : '5') + '08bfaab9d8d7b4ccac08bfaab9d8d7b4ccac08bfaab9d8d7b4ccac0000000000015' + (parseInt(deviceSerial.charAt(deviceSerial.length - 1)) - 1) + '3' + (deviceConfig.type === 'color' ? '2' : '3') + '00'))
                      // Brightness
                      commandsToExecute.push(...this.generateAqaraS1ScenePanelCommands('02', slotPrefix + slots[1].toString(16).padStart(2, '0') + panelSerial + deviceSerial + '0e010055' + '170a0' + (deviceConfig.type === 'dim' ? '4' : '5') + '0ac1c1b6c8b0d9b7d6b1c8000000000000015' + (parseInt(deviceSerial.charAt(deviceSerial.length - 1)) - 1) + '0' + (deviceConfig.type === 'color' ? '2' : '4') + '00'))
                      // Name
                      commandsToExecute.push(...this.generateAqaraS1ScenePanelCommands('02', slotPrefix + slots[4].toString(16).padStart(2, '0') + panelSerial + deviceSerial + '08001fa5' + '140a0' + (deviceConfig.type === 'dim' ? '4' : '5') + '08c9e8b1b8c3fbb3c60000000000015' + (parseInt(deviceSerial.charAt(deviceSerial.length - 1)) - 1) + '0' + (deviceConfig.type === 'color' ? 'a' : 'b') + '00'))
                      // Online/Offline
                      commandsToExecute.push(...this.generateAqaraS1ScenePanelCommands('02', slotPrefix + slots[5].toString(16).padStart(2, '0') + panelSerial + deviceSerial + '080007fd' + '160a0' + (deviceConfig.type === 'dim' ? '4' : '5') + '0ac9e8b1b8d4dacfdfc0eb0000000000015' + (parseInt(deviceSerial.charAt(deviceSerial.length - 1)) - 1) + '3' + (deviceConfig.type === 'color' ? 'c' : 'd') + '00'))
                      if (deviceConfig.type === 'ct') {
                        // Color Temperature
                        commandsToExecute.push(...this.generateAqaraS1ScenePanelCommands('02', slotPrefix + slots[2].toString(16).padStart(2, '0') + panelSerial + deviceSerial + '0e020055' + '130a0506c9abcec2d6b5000000000000015' + (parseInt(deviceSerial.charAt(deviceSerial.length - 1)) - 1) + '0300'))
                      } else if (deviceConfig.type === 'color') {
                        // Color
                        commandsToExecute.push(...this.generateAqaraS1ScenePanelCommands('02', slotPrefix + slots[3].toString(16).padStart(2, '0') + panelSerial + deviceSerial + '0e080055' + '130a0506d1d5c9ab7879000000000000015' + (parseInt(deviceSerial.charAt(deviceSerial.length - 1)) - 1) + '0100'))
                      }
                      ...
                      commandsToExecute.push(...this.generateAqaraS1ScenePanelCommands('02', slotPrefix + slots[0].toString(16).padStart(2, '0') + panelSerial + deviceSerial + '0e020055' + '150a0' + (deviceConfig.type === 'curtain' ? '4' : '5') + '08b4b0c1b1d7b4ccac000000000000014' + (parseInt(deviceSerial.charAt(deviceSerial.length - 1)) + 5) + '3' + (deviceConfig.type === 'curtain' ? '2' : '3') + '00'))
                      // Position
                      ...
                      commandsToExecute.push(...this.generateAqaraS1ScenePanelCommands('02', slotPrefix + slots[1].toString(16).padStart(2, '0') + panelSerial + deviceSerial + '01010055' + '190a0' + (deviceConfig.type === 'curtain' ? '4' : '5') + '0000010ab4b0c1b1b4f2bfaab0d90000000000014' + (parseInt(deviceSerial.charAt(deviceSerial.length - 1)) + 5) + '0' + (deviceConfig.type === 'curtain' ? 'c' : 'd') + '00'))
                      // Online/Offline
                      ...
                      commandsToExecute.push(...this.generateAqaraS1ScenePanelCommands('02', slotPrefix + slots[2].toString(16).padStart(2, '0') + panelSerial + deviceSerial + '080007fd' + '160a0' + (deviceConfig.type === 'curtain' ? '4' : '5') + '0ac9e8b1b8d4dacfdfc0eb0000000000014' + (parseInt(deviceSerial.charAt(deviceSerial.length - 1)) + 5) + '3' + (deviceConfig.type === 'curtain' ? 'c' : 'e') + '00'))
                      // Name
                      ...
                      commandsToExecute.push(...this.generateAqaraS1ScenePanelCommands('02', slotPrefix + slots[3].toString(16).padStart(2, '0') + panelSerial + deviceSerial + '08001fa5' + '140a0' + (deviceConfig.type === 'curtain' ? '4' : '5') + '08c9e8b1b8c3fbb3c60000000000014' + (parseInt(deviceSerial.charAt(deviceSerial.length - 1)) + 5) + '0' + (deviceConfig.type === 'curtain' ? 'a' : 'b') + '00'))
                      ...
                      commandsToExecute.push(...this.generateAqaraS1ScenePanelCommands('02', slotPrefix + slots[5].toString(16).padStart(2, '0') + panelSerial + deviceSerial + '00010055' + '190a050000010ab4b0c1b1d4cbd0d0cab10000000000014' + (parseInt(deviceSerial.charAt(deviceSerial.length - 1)) + 5) + '3f00'))
                    } else if (i === 8) { // AC
                      // On/Off, general type...
                      ...
                      // Online/Offline
                      commandsToExecute.push(...this.generateAqaraS1ScenePanelCommands('02', slotPrefix + slots[1].toString(16).padStart(2, '0') + panelSerial + deviceSerial + '080007fd' + '1608060ac9e8b1b8d4dacfdfc0eb0000000000012e6400'))
                      // Name
                      commandsToExecute.push(...this.generateAqaraS1ScenePanelCommands('02', slotPrefix + slots[2].toString(16).padStart(2, '0') + panelSerial + deviceSerial + '08001fa5' + '14080608c9e8b1b8c3fbb3c60000000000012e1300'))
                      // Modes
                      commandsToExecute.push(...this.generateAqaraS1ScenePanelCommands('02', slotPrefix + slots[3].toString(16).padStart(2, '0') + panelSerial + deviceSerial + '08001fa7' + '1608060ab5b1c7b0c6a5c5e4b5c40000000000012e1000'))
                      // Fan Modes
                      commandsToExecute.push(...this.generateAqaraS1ScenePanelCommands('02', slotPrefix + slots[4].toString(16).padStart(2, '0') + panelSerial + deviceSerial + '08001fa8' + '1608060ab5b1c7b0c6a5c5e4b5c40000000000012e1100'))
                      // Temperatures Ranges
                      commandsToExecute.push(...this.generateAqaraS1ScenePanelCommands('02', slotPrefix + slots[5].toString(16).padStart(2, '0') + panelSerial + deviceSerial + '08001fa9' + '1608060ab5b1c7b0c6a5c5e4b5c40000000000012e0100'))
                    } else if (i === 9) { // Temperature Sensor
                      // Temperature
                      commandsToExecute.push(...this.generateAqaraS1ScenePanelCommands('02', slotPrefix + slots[0].toString(16).padStart(2, '0') + panelSerial + deviceSerial + '00010055' + '1908023e00640a74656d706572617475720000000000012c0600'))
                      // Humidity
                      commandsToExecute.push(...this.generateAqaraS1ScenePanelCommands('02', slotPrefix + slots[1].toString(16).padStart(2, '0') + panelSerial + deviceSerial + '00020055' + '1708021d00640868756d69646974790000000000012c0900'))
                    }
                    ...
                    if (parsedData[i]) {
                      ...
                      for (let ii = slots.length - 1; ii >= 0; ii--) {
                        commandsToExecute.push(...this.generateAqaraS1ScenePanelCommands('04', slotPrefix + slots[ii].toString(16).padStart(2, '0') + panelSerial + '000000000000000000000000'))
                      }
                      this.configurationCommandsToExecute.push({
                        commands: commandsToExecute,
                        meta: {
