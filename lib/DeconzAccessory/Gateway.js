  ...
  setAqaraS1PanelsConfiguration() {
    ...
    if (this.actionsConfigData && Array.isArray(this.actionsConfigData) === false) {
      ...
      if (aqaraS1Panels) {
        ...
        const devicesSerial = ['6c69676874732f31', '6c69676874732f32', '6c69676874732f33', '6c69676874732f34', '6c69676874732f35', '6375727461696e31', '6375727461696e32', '6375727461696e33', '6169725f636f6e64'] // array of devices serial which is configured when setup is done
        const devicesControl = ['light_1', 'light_2' , 'light_3', 'light_4', 'light_5', 'curtain_1', 'curtain_2', 'curtain_3', 'ac'] // array of config names
