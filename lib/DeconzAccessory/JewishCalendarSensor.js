...
class JewishCalendarSensor extends AccessoryDelegate {
  ...
  constructor (platform, jewishCalendarConfig) {
    ...
    this.services.ShushanPurim = new DeconzService.JewishCalendarSensor(this, {name: "ShushanPurim", subtype: "ShushanPurim"});
    this.services.PurimMeshulash = new DeconzService.JewishCalendarSensor(this, {name: "PurimMeshulash", subtype: "PurimMeshulash"});
    this.services.ShvihiShelPesach = new DeconzService.JewishCalendarSensor(this, {name: "ShvihiShelPesach", subtype: "ShvihiShelPesach"});
    this.services.LeapYear = new DeconzService.JewishCalendarSensor(this, {name: "LeapYear", subtype: "LeapYear"});
...
*/
  ...
  isShushanPurim() {
    // Leap years can make Adar2's month number "bounce" so we check for it
    var isPurimMeshulash = this.isPurimMeshulash();
  ...
  isPurimMeshulash() {
    // Leap years can make Adar2's month number "bounce" so we check for it
    var shushanPurimDate = new HeDate(this.hDate.getFullYear(), this.hebrewMonths.Adar2, 14);
