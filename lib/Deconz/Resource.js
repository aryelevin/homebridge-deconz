  ...
  get _serviceName () {
    if (this.rtype === 'groups') {
      ...
      switch (type) {
        ...
        case 'Thermostat': return (this.body.config.coolsetpoint !== undefined || this.body.config.temperature !== undefined) && this.body.config.fanmode !== undefined ? 'HeaterCooler' : 'Thermostat'
        case 'Time': return ''
