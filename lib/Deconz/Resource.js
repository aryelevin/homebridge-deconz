...
class Resource {
  ...
  get _serviceName () {
    if (this.rtype === 'groups') {
      ...
      switch (type) {
        ...
        case 'Thermostat': return this.body.config.coolsetpoint !== undefined && this.body.config.fanmode !== undefined ? 'HeaterCooler' : 'Thermostat'
        case 'Time': return ''
  ...
  * @param {DeconzAccessory.Gateway} gateway - The gateway.
  ...
  /** Patch a resource corresponding to a `Thermostat` service.
    */
  patchThermostat () {
    if ((this.manufacturer === 'ELKO' && this.model === 'Super TR') || (this.manufacturer === 'LUMI' && this.model === 'lumi.airrtc.agl001')) {
