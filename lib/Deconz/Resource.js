...
class Resource {
  ...
  get _serviceName () {
    if (this.rtype === 'groups') {
      ...
      const type = /^(CLIP|ZHA|ZGP)?([A-Za-z0-9]*)$/.exec(this.body.type)?.[2]
      switch (type) {
        ...
        case 'AqaraS1ScenePanelSwitch': return 'Label'
        case 'Spectral': return ''
        case 'Switch': return 'Label'
        case 'Temperature': return 'Temperature'
        case 'Thermostat': return ((this.body.config.coolsetpoint !== undefined && this.body.config.fanmode !== undefined) || (this.body.config.externalsensortemp !== undefined && this.body.config.speed !== undefined) /* <- This is for the Aqara VRF controller integration..*/)  ? 'HeaterCooler' : 'Thermostat'
        case 'Time': return ''
