      ...
      case 'LUMI':
        switch (this.model) {
          ...
          case 'lumi.switch.n4acn4': // Xiaomi Aqara S1 Scene Panel
            buttons.push([1, 'Scene 1', LONG])
            buttons.push([2, 'Scene 2', LONG])
            buttons.push([3, 'Scene 3', LONG])
            buttons.push([4, 'Scene 4', LONG])
            buttons.push([5, 'Scene 5', LONG])
            buttons.push([6, 'Scene 6', LONG])
            break
          default:
            break
        }
